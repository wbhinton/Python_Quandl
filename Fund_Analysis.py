...
This looks all of the available tickers and then writes the data to a csv file.
...
ql.ApiConfig.api_version = "2015-04-09"

"""Get and Parse JSON Date"""
...
for i in jdata:
        ...
        """Calculations-- BuyRating is how we are rating the stock on a 
         scale of 1-8"""
        BuyRating = 0
        ...
        """Write out data and print confirmations"""
        out = [tic, BuyRating, CurrentPrice, AcceptablePrice,
               EBITDA.iat[0, 0], CurrentPE, PreviousPE, CNPM]
        writer.writerow(out)
        print(tic + " was successful")
    except:
        print(tic + " failed")
        continue
